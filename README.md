...
Currently, I serve as a **Climate Geographer** at the Geospatial Operations Support Team ([**GOST**](https://worldbank.github.io/GOST/README.html)) of the Development Economic Data Group ([**DECDG**](https://www.worldbank.org/en/about/unit/unit-dec/dev)) at The World Bank, Washington, DC. Collaborating with teams across the bank, I offer expertise in geospatial and climate analytics on a global scale. I also support the [Risk Data Library](https://riskdatalibrary.org/) project, led by a team from the Global Facility for Disaster Reduction and Recovery ([GFDRR](https://www.gfdrr.org/en)). Serving as a **Risk Data Librarian** ([Data Scientist](https://riskdatalibrary.org/team/)), I make HEVL data play nice together for standardized risk insight. FAIR data for unfair disasters.
